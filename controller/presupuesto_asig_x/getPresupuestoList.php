...
if(isset($_POST['desde']) && isset($_POST["hasta"])){
	...
	if(is_numeric($desde) && is_numeric($hasta)){
        ...
        $area=new presupuesto_asig_x($mi_conexion->getCurrentConnection());
        $cantidad = 20;
        $data_area = $area->getPresupuestoAsigList($desde, $cantidad);
        $data_paginacion = $area->getPresupuestoAsigCount($cantidad);
